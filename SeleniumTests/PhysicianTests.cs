...
namespace SeleniumTests
{
    ...
    public class PhysicianTests
    {
        ...
        //          Insteaad, create once instance of a ChromeDriver, Login as dr smith ONE time ([ClassInitialize])
        ...
        public void Physician_Can_Create_A_New_Patient()
        {
            ...
            //** NOTE: This 'new patient' isn't actually getting saved anywhere, but in a really application expect that it would

            //** HINT 3: Run some custom javascript.  There is a javascript function in the 'Selenium Test - New Patient' page, called 'aCustomJavaScript()', call this function from selenium
            //           Google 'c# selenium run javascript'
